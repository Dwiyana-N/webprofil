    ...
    public function store(Request $request){
      try{
        ...
        if(!empty($request->file('img'))){
          ...
          $image->storeAs('public/profile/images', $img);
        } else {
          $img = null;
        }
        //upload file
        if(!empty($request->file('file'))){
          ...
          $berkas->storeAs('public/profile/files', $file);
        } else {
          $file = null;
        }
    ...
    public function update(Request $request){
      try{
        ...
        if( $request->file('img') == '' ) {
          ...
          $imagepic = Storage::disk('local')->delete('public/profile/images/'.$baseimage);
          $image->storeAs('public/profile/images/', $img);
        }
        //upload file
        if( $request->file('file') == '' ) {
          ...
          $doc = Storage::disk('local')->delete('public/profile/files/'.$basefile);
          $berkas->storeAs('public/profile/files/', $file);
        }
        $data = $this->bindData($request);
        $data['img'] = $img;
