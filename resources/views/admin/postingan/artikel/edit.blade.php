            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Sunting Data Berita</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
...
$(document).ready(function () {
  ...
  $('#quickForm').validate({
    ...
    messages: {
      ...
      tag_id: {
        required: "&nbsp;"+"Kolom tidak boleh kosong, pilih tag berita",
      },
      img: {
        required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan gambar berita",
      },
      status: {
