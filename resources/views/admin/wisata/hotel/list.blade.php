            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data hotel</h3>
                  <a href="{{route('admin.hotel.create')}}" class="btn btn-success float-right">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;">
                        <a href="{{route('admin.hotel.show',['id' => $row->id])}}" class="btn btn-md btn-secondary btn-icon" title="Detail">
                          <i class="fas fa-info-circle"></i>
                        </a>
                        <a href="{{route('admin.hotel.edit',['id' => $row->id])}}" class="btn btn-md btn-primary btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.hotel.delete') }}" method="POST" class="d-none">
                              @csrf
