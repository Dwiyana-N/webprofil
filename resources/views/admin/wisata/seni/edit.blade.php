...
@section('title', 'Sunting Kesenian dan Budaya')
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Sunting Data Kesenian dan Budaya</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.seni.update')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    @if($fetch->img)
                    <img src="{{asset('/storage/seni-budaya/images/'.$fetch->img)}}" width="450px" height="auto">   
                    @endif
