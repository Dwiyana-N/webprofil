...
<script type="text/javascript">
  $(document).ready(function () {
    $('#quickForm').validate({
      ...
      messages: {
        title: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi judul wisata",
        },
        img: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi gambar wisata",
        },
        description: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi deskripsi wisata",
        },
      },
      errorElement: 'span',
