...
@section('title', 'Sunting Data Kesenian da Kebudayaan')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Kesienan da Kebudayaan</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><small><strong>Content</strong></small></li>
            <li class="breadcrumb-item"><small><strong>Kesenian da Kebudayaan</strong></small></li>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Sunting Data Kesenian da Kebudayaan</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="{{route('admin.kesenian.update')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="card-body">                    
                    ...
                    @if($fetch->img)
                    <img src="{{asset('/storage/kesenian/images/'.$fetch->img)}}" width="450px" height="auto">   
                    @endif
...
<script type="text/javascript">
  $(document).ready(function () {
    $('#quickForm').validate({
      ...
      messages: {
        title: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi judul kesenian",
        },
        img: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi gambar kesenian",
        },
        description: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, isi deskripsi kesenian",
        },
      },
      errorElement: 'span',
