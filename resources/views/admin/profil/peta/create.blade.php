...
@section('title', 'Tambah Data Peta')
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Tambahkan Data Peta</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="{{route('admin.peta.add')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">                    
