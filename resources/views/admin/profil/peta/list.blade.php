      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><small><strong>Peta</strong></small></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach($peta as $list)
                    <tr>
                      <td>{{$list->title}}</td>
                      <td>{{\Carbon\Carbon::parse($list->created_date)->translatedFormat('l, d F Y')}}</td>
                      <td>{{$list->status}}</td>
                      <td>
                        <a href="{{route('admin.peta.show',['id' => $list->id])}}" class="btn btn-md btn-secondary btn-icon" title="Detail">
                          <i class="fas fa-info-circle"></i>
                        </a>
                        <a href="{{route('admin.peta.edit',['id' => $list->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                          <i class="fas fa-edit"></i>
                        </a>
                        <a href="{{route('admin.peta.delete', ['id' => $list->id])}}" data-toggle="modal" data-target="#hapus{{$list->id}}" class="btn btn-md btn-danger btn-icon" title="Hapus">
