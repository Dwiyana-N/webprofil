          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="row">
              ...
              @foreach ($hotel as $data)
                <div class="col-sm-12 col-md-6 col-lg-6">
                  <div class="blog-item">
                    <div class="blog__img">
                      <a href="{{route('public.hotel.detail',['slug'=>$data->slug])}}">
                        <img height="190px" width="190px"  src="{{($data->img) ? asset('/storage/hotel/images/'.$data->img) : asset('backend/img/default.png')}}" alt="{{$data->title}}">
                      </a>
                    </div><!-- /.entry-img -->
                    <div class="blog__content">
                      <h4 class="blog__title"><a href="{{route('public.hotel.detail',['slug'=>$data->slug])}}">{{$data->title}}</a></h4>
                      <a href="{{route('public.hotel.detail',['slug'=>$data->slug])}}" class="btn btn__secondary btn__link">Selengkapnya</a>
                    </div><!-- /.entry-content -->
                  </div><!-- /.blog-item -->
                </div><!-- /.col-lg-4 -->
              @endforeach
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                ...
                <div>{{ $hotel->links('public.layout.pagination') }}</div>
              </div><!-- /.col-lg-12 -->
            </div><!-- /.row -->
          </div><!-- /.col-lg-8 -->
