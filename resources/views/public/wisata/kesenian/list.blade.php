@extends('public.layout.app', ['title' => 'Kesenian'])

@section('meta')
  <meta name="description" content="Kesenian Terbaru" />
  <meta name="keywords" content="Diskominfo Subang" />
  <meta property="og:title" content="Kesenian Terbaru"/>
  <meta property="og:type" content="Kesenian"/>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">Kesenian</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
