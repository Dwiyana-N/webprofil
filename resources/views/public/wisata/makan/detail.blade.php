@extends('public.layout.app', ['title' => $makan->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($makan->description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($makan->title)}}" />
  <meta property="og:title" content="{{$makan->title}} "/>
  <meta property="og:type" content="{{$makan->title}}"/>
  <meta property="og:image" content="{{($makan->img)?asset('/storage/makan/images/'.$makan->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        ...
        <div class="blog-item blog-single-item">
          <li class="list-group-item list-group-item-action">
            <div class="blog__img">
              <a href="#">
                <img src="{{($makan->img)? asset('/storage/makan/images/'.$makan->img) : asset('backend/img/default.png')}}" alt="blog image">
              </a>
            </div><!-- /.entry-img -->
            <div class="blog__content">
              <div class="line-bottom"></div>
              <h4 class="blog__title">{{ $makan->title }}</h4>
