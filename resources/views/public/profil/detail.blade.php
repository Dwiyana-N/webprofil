...
@section('meta')
  ...
  <meta property="og:image" content="{{($profil->img)?asset('/storage/profil/images/'.$profil->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        <div class="blog-item blog-single-item">
          <div class="blog__content">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8">
                <h1 class="heading__title">{{ $profil->title }}</h1>
